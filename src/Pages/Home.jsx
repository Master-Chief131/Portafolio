...
const TECH_STACK = ["SpringBoot", "Python", "Java", "React", "Javascript", "Node.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Master-Chief131" },
  { icon: Linkedin, link: "https://linkedin.com/in/luis-marquez-686b1a1bb/" },
  { icon: Instagram, link: "https://instagram.com/luis_marquez31" }
];
